...
public static class MessageHeaders
{
    private static readonly IReadOnlyDictionary<MessageType, string> ToWire =
        new Dictionary<MessageType, string>
        {
            ...
            [MessageType.ItemList] = "ILIST",
            [MessageType.JoinSnapshot] = "JOINSTATE",
            [MessageType.PickCharacter] = "PICK",
            [MessageType.CharacterSelected] = "PICKOK",
            ...
            [MessageType.GameTokenRequest] = "GTREQ",
            [MessageType.GameTokenIssued] = "GTISS",
